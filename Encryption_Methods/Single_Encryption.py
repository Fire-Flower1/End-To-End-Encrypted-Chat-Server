...
class SingleEncryption:
    ...
    def encrypt(self, data):
        ...
        return (cipher.iv + ciphered_data).hex()  # hex encode IV and ciphertext

    def decrypt(self, cipher_data):
        cipher_data = bytes.fromhex(cipher_data.decode())  # hex decode ciphertext
        ...
        return original_data.decode()  # return as decoded string
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if q == "Encrypt":
            ...
            print(encrypt.decrypt(input("Encrypted data? ")))  
        elif q == "Quit":
            break
        else:
